  ...
  <SafeAreaView style={{flex:1,backgroundColor:'#fca503'}}>
    <ScrollView>
      <View style={{ flex: 1,margin:20}}>
        <Image source={Logo} style={{marginTop:120, width: 300,height: 130,resizeMode: 'contain'}} />
        <Text style={style.bodyText}></Text>
        
          <TextInput
            style={ {backgroundColor:'#ffffff',marginTop:20,paddingLeft:10}}
            value={username}
          ...
          <TextInput
            ...
            style={{backgroundColor:'#ffffff',marginTop:10,paddingLeft:10}}
